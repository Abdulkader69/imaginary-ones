import Phase1IMG1 from '../assets/images/key-visual-desktop.jpg';
import Phase1Video1 from '../assets/videos/walk-1.mp4';
import Phase1IMG2 from '../assets/images/key-visual-desktop.jpg';
import Phase1Video2 from '../assets/videos/walk-1.mp4';
import Phase1IMG3 from '../assets/images/key-visual-desktop.jpg';
import Phase1Video3 from '../assets/videos/walk-1.mp4';
import BallGreen from '../assets/images/ball-green.png';
const WorldPhaseOne = () => {
  return (
    <>
      <div className="phase phase-one bg-[#fff1f1]">
        <div className="relative max-w-[1500px] m-auto px-7 z-20 flex flex-wrap">
          ...
          <div className="content w-4/5 max-w-4xl p-10">
            <h2 className="text-3xl font-filson font-bold text-black uppercase">
              Phase 01
            </h2>
            <h3 className="text-[2.75rem] text-[#1ab791] uppercase font-filson font-bold mb-5">
              The Idea - (We&apos;re Here!)
            </h3>
            <div className="context text-2xl text-black leading-6">
          ...
          <div className="media w-full">
            <div className="media-list w-full max-w-4xl m-auto flex">
