  ...
  return (
    <div className="imaginary-values-wrapper bg-[rgb(255,248,243)] overflow-hidden relative">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="w-1/3 bg-[rgb(255,236,237)] p-14 text-center">
          <div className="video p-14">
            <video autoPlay loop muted playsInline poster={sparkImg.src}>
              <source data-src={sparkVideo} src={sparkVideo} />
            </video>
          </div>
          <h3 className="text-black text-[48px] text-center  font-filson uppercase font-extrabold">
            Find Your Spark
          </h3>
        ...
        <div className="w-1/3 bg-[rgb(240,255,248)] p-14 text-center">
          <div className="video p-14">
        ...
        <div className="w-1/3 bg-[rgb(244,242,255)] p-14 text-center">
          <div className="video p-14">
