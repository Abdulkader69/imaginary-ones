const WorldHeadline = () => {
  return (
    <>
      <div className="headline-section pt-40 pb-24 bg-[#fff1f1]">
        <div className="first-layer relative max-w-[1500px] m-auto px-7 z-20">
          <h1 className="headline text-9xl font-filson text-[#8459ff] font-extrabold uppercase mb-2">
            <div className="block relative">
              <div className="inline-block relative mr-8">
                ...
                <div className=" inline-block">d</div>
          ...
          <h2 className="text-5xl font-filson font-extrabold text-black leading-4 uppercase">
