...
const What = () => {
  ...
  return (
    <div className="why-section py-48 lg:py-80 bg-[#8459ff] relative overflow-hidden">
      <div className="first-layer relative max-w-[1500px] m-auto px-7 z-20">
        <h2 className="headline text-4xl lg:text-6xl xl:text-8xl 2xl:text-9xl font-filson text-white font-extrabold uppercase">
        ...
        <div className="why-text text-lg md:text-[1.5rem] 2xl:text-[2rem] text-white mt-8 leading-[1.4]">
          <p className="mb-8">
      ...
      <div className="why-item floating absolute top-0 left-0 w-full h-full duration1">
        <Draggable defaultPosition={{ x: 0, y: 0 }}>
          <div className="absolute -top-[50px] lg:top-[200px] -left-[200px] lg:-left-[150px]">
      ...
      <div className="why-item floating absolute top-0 left-0 w-full h-full duration2">
        <Draggable defaultPosition={{ x: 0, y: 0 }}>
          <div className="absolute -right-[300px] lg:-right-[100px] -bottom-[300px] lg:-bottom-[200px]">
            <img
      ...
      <div className="why-item hidden lg:inline-block floating absolute right-[5%] top-[23%] w-[320px] h-[320px] duration3 z-10">
        <Draggable defaultPosition={{ x: 0, y: 0 }}>
          <div
      ...
      <div className="why-item floating absolute left-[30%] top-[3%] w-[150px] lg:w-[320px] h-[150px] lg:h-[320px] duration3 z-10">
        <Draggable defaultPosition={{ x: 0, y: 0 }}>
          <div
            className="absolute cursor-pointer"
      ...
      <div className="why-item floating absolute bottom-0 left-[2%] w-[200px] lg:w-[360px] h-[200px] lg:h-[360px] duration4 z-10">
        <Draggable defaultPosition={{ x: 0, y: 0 }}>
          <div
            className="absolute cursor-pointer"
