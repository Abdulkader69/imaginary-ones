...
import Rainbow from '../assets/videos/rainbow-circle-black.mp4';
import StrawHat from '../assets/images/straw-hat.png';
import PlantHat from '../assets/images/plant-head.png';
import Scuba from '../assets/images/scuba.png';
import SnowCap from '../assets/images/snow-cap.png';
...
import Ball1 from '../assets/images/ball-light-green.png';
import Ball2 from '../assets/images/ball-blue.png';
import Ball3 from '../assets/images/ball-pink.png';
import Ball4 from '../assets/images/ball-beige.png';
import Ball5 from '../assets/images/ball-yellow.png';
import Ball6 from '../assets/images/ball-purple.png';
...
const ParallaxBanner = ({
  ...
  return (
    <div
      ...
      className="loading-screen fixed top-0 left-0 w-full h-full z-50 bg-[#fff2f2] overflow-hidden"
    >
      <div className="preloader-content absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 py-8 z-10">
        <div className="preloader-rainbow relative w-[300px] overflow-hidden">
          <video
            className="w-[calc(100%-2px)] h-[calc(100%-3px)] object-cover block absolute top-[1px] left-[1px]"
            autoPlay
            loop
            muted
            playsInline
            // poster={cmtImg.src}
          >
            <source data-src={Rainbow} src={Rainbow} />
          </video>
          <svg
          ...
          >
            <defs>
              <mask id="preloader-mask" x="0" y="0" width="100%" height="100%">
        ...
        <div
          className={`rainbow-loader-text uppercase text-xl text-black font-filson font-bold text-center mt-8 transition ease-in tracking-wide ${
        ...
        <div
          className={`button absolute bottom-0 text-center left-0 right-0 m-auto ${
        ...
        >
          <div className="floating duration1 w-full h-full">
            <Draggable defaultPosition={{ x: 0, y: 0 }}>
              ...
              >
                <img
                  src={changeImage ? PlantHat.src : StrawHat.src}
                  alt="Frankenstein"
                  className="rotate-[17deg] pointer-events-none w-full"
                />
              </div>
            </Draggable>
          </div>
        ...
        >
          <div className="floating duration2 w-full h-full">
            <Draggable defaultPosition={{ x: 0, y: 0 }}>
              ...
              >
                <img
                  src={changeImage2 ? SnowCap.src : Scuba.src}
                  alt="Frankenstein"
                  className="-rotate-6 pointer-events-none w-full"
                />
              </div>
            </Draggable>
          </div>
        ...
        >
          <div className="floating duration3 w-full h-full">
            <Draggable defaultPosition={{ x: 0, y: 0 }}>
              ...
              >
                <img
                  src={changeImage3 ? Frankenstein.src : Hoodie.src}
                  alt="Frankenstein"
                  className="rotate-[17deg] pointer-events-none w-full"
                />
              </div>
        ...
        >
          <div className="floating duration4 w-full h-full">
            <Draggable defaultPosition={{ x: 0, y: 0 }}>
              <div
                className="absolute cursor-pointer w-full"
                onClick={() => setChangeImage4((prevMode) => !prevMode)}
              >
                <img
                  src={changeImage4 ? Astronaut.src : Triceratops.src}
                  alt="Frankenstein"
                  className="-rotate-[10deg] pointer-events-none w-full"
                />
              </div>
            </Draggable>
          </div>
